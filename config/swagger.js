...
const swaggerOptions = {
  definition: {
    ...
    tags: [
      {
        name: "Authentication",
        description: "Register, verify, login, logout, password reset",
      },
      {
        name: "Profile",
        description: "Alumni profile CRUD, search, and image upload",
      },
      {
        name: "Bidding",
        description: "Monthly bidding for the Alumnus-of-the-Day slot",
      },
      {
        name: "Public API",
        description: "Read-only endpoints intended for API-token consumers",
      },
      {
        name: "Analytics",
        description: "Aggregate analytics over alumni profiles",
      },
      {
        name: "Admin",
        description: "Token management and operational endpoints",
      },
    ],
    components: {
      securitySchemes: {
        ...
        apiKeyAuth: {
          ...
          name: "Authorization",
          description:
            "API token created by an admin via `POST /api/admin/tokens`. Send as `Authorization: Bearer <token>`.",
        },
      },
      ...
      schemas: {
        ...
        Profile: {
          ...
          properties: {
            ...
            profileImage: {
              type: "string",
              description: "Filename returned by upload-image",
            },
            degrees: {
              type: "array",
            ...
            employmentHistory: {
              type: "array",
              items: { $ref: "#/components/schemas/EmploymentEntry" },
            },
            sponsorshipOffers: {
              type: "array",
              items: { $ref: "#/components/schemas/SponsorshipOffer" },
            },
        ...
        ProfileUpsertRequest: {
          ...
          properties: {
            ...
            eventParticipationThisMonth: {
              type: "boolean",
              description:
                "When true, marks the user as event-participating for the current month (raises win cap to 4)",
            },
          },
        },
        ProfileSearchResult: {
          ...
          items: {
            ...
            properties: {
              _id: { type: "string" },
              personalInfo: {
                $ref: "#/components/schemas/Profile/properties/personalInfo",
              },
              employmentHistory: {
                type: "array",
                items: { $ref: "#/components/schemas/EmploymentEntry" },
        ...
        WinnerSummary: {
          type: "object",
          description:
            "Public-facing winner snapshot returned by today/tomorrow endpoints",
          properties: {
            winner: {
              type: "object",
              properties: {
        ...
        ApiTokenCreateResponse: {
          ...
          properties: {
            token: {
              type: "string",
              description:
                "Plaintext token — store immediately, it is not shown again",
            },
            name: { type: "string" },
            permissions: {
              type: "array",
